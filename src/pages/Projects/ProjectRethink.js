...
function ProjectRethink(props) {
  const [swiperControl, setSwiperControl] = useState({});
  const index = ProjectList.findIndex((element) => element.name === "Rethink");
  // const index = 1;
  ...
  return (
    <>
      <MegaText text="Rethink" percentage={percentage} />
