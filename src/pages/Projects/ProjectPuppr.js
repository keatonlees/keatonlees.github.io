...
function ProjectPuppr(props) {
  const [swiperControl, setSwiperControl] = useState({});
  const index = ProjectList.findIndex((element) => element.name === "Puppr");
  // const index = 1;
  ...
  return (
    <>
      <MegaText text="Puppr" percentage={percentage} />
