...
function ProjectOctodo(props) {
  const [swiperControl, setSwiperControl] = useState({});
  const index = ProjectList.findIndex((element) => element.name === "Octo-Do");
  // const index = 1;
  ...
  return (
    <>
      <MegaText text="Octodo" percentage={percentage} />
