...
function ProjectJarvis(props) {
  const [swiperControl, setSwiperControl] = useState({});
  const index = ProjectList.findIndex((element) => element.name === "Jarvis");
  // const index = 1;
  ...
  return (
    <>
      <MegaText text="Jarvis" percentage={percentage} />
